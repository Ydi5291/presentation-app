  ...
  <>
    ...
    <div className="about-container">
      <div className="about-text">
        ...
        <p>
          Ich arbeite mit modernen Technologien wie HTML5, CSS3, JavaScript und React. Auch setze ich zusätzlich Automatisierungstools für effiziente Prozesse ein. Mein Ziel ist es, innovative digitale Lösungen zu entwickeln und mich ständig weiterzuentwickeln.
        </p>
      </div>
    </div>
  </>
